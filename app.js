...
function renderRequestResult(resultDiv, responses) {
    try {
        ...
        render.setAttribute('src', '/_themes/docs.theme/master/en-us/_themes/scripts/8fb53e85.index-docs.js');
        document.body.appendChild(render);
        var s2 = document.createElement('script');
        s2.setAttribute('src', 'https://www.google-analytics.com/analytics.js');
